...
namespace HoloHands
{
   ...
   public:
      ...
      bool GetIsClosed() { return _isClosed; }
   ...
   private:
      ...
      const float DEPTH_SAMPLE_LENGTH = 20.f; //Higher == Move the depth sample point deeper into the palm.
      ...
      const float DEPTH_SAMPLE_MIN = 0; //Minimum valid sample value, lower value will be discarded.
      ...
      float HandDetector::CalculateDepth(
